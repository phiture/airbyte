...
def patch_base_class(mocker):
    ...
    mocker.patch.object(BrazeStream, "path", "v0/example_endpoint")
    mocker.patch.object(BrazeStream, "primary_key", "test_primary_key")
    mocker.patch.object(BrazeStream, "__abstractmethods__", set())
