...
import pytest
from source_phiture_adjust.source import AdjustStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AdjustStream, "path", "v0/example_endpoint")
    mocker.patch.object(AdjustStream, "primary_key", "test_primary_key")
    mocker.patch.object(AdjustStream, "__abstractmethods__", set())
